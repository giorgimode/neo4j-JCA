...
public class Neo4jResourceAdapter implements ResourceAdapter
{
   ...
   /** The logger */
   private static Logger log = Logger.getLogger(Neo4jResourceAdapter.class.getName());
   ...
   public int hashCode()
   {
      ...
      if (rootDirectory != null)
         result += 31 * result + 7 * rootDirectory.hashCode();
      else
         result += 31 * result + 7;
      return result;
   }
   ...
   public boolean equals(Object other)
   {
      ...
      {
         if (rootDirectory == null)
            result = obj.getRootDirectory() == null;
         else
            result = rootDirectory.equals(obj.getRootDirectory());
      }
      return result;
   }
